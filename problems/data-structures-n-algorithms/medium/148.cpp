...
ListNode *merge(ListNode *list, ListNode *left, ListNode *right) {
	ListNode *res = new ListNode(), *iter = NULL;
	iter = res;
...
ListNode *mergeSort(ListNode *list, ListNode *head, ListNode *tail) {
	ListNode *fast = head, *slow = head, *mid, *next;
	...
	ListNode *left = mergeSort(list, head, mid);
	ListNode *right = mergeSort(list, next, tail);
	ListNode *res = merge(list, left, right);
	return res;
}
...
ListNode *sortList(ListNode *head) {
	...
	return mergeSort(head, head, tail);
}
