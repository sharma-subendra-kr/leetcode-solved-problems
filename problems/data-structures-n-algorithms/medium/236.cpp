...
stack<pair<TreeNode *, int>> traverse(TreeNode *root, TreeNode *node) {
...
TreeNode *lowestCommonAncestor(TreeNode *root, TreeNode *p, TreeNode *q) {
	stack<pair<TreeNode *, int>> ps = traverse(root, p);
	stack<pair<TreeNode *, int>> qs = traverse(root, q);
	stack<pair<TreeNode *, int>> *curr = NULL;
	pair<TreeNode *, int> ip, iq;
...
int main() {
	...
	TreeNode *res = lowestCommonAncestor(head, node0, node3);
